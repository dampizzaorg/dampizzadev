...
public class ManagerOrderPresenter {
    ...
    private ObservableList<UserDTO> dealerList;
...
//                oblItems = FXCollections.observableArrayList(App.getCurrentOrder().getProducts());
    ...
    public void confirm() {
        try {
            ...
            App.getCurrentOrder().setDealer(dealerList.get(cbDealer.getSelectionModel().getSelectedIndex()));
    ...
    /**
     * Method that make a list with the names of the dealers
     *
     * @param dealerList dealers objects
     * @return string list with the names and surmanes of each dealer
     */
